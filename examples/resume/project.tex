...
%   \cventry
%     {}
%     {Counter and Arithmatic unit for Xilinx Spartan-II} % Title
%     {2014} % Location
%     {}
%     %{Spring 2017} % Date(s)
%     {
%       \vspace{-3mm}
%       \begin{cvitems} % Description(s)
%         \item {Built a seven segment counter and arithmatic unit using Verilog for Xilinx Spartan-II FPGA board}
%         %\item {Tools: Scala, Apache Maven, Lucene}
%       \end{cvitems}
%     }
%     {}
...
%   \cventry
%     {} % Conference
%     {Car design with Microcontroller} % Title
%     {2013} % Location
%     {} % Date(s)
%     {
%       \vspace{-3mm}
%       \begin{cvitems} % Authors; comma separated
%         \item {Designed an 8-bit instruction controlled dual motor car with Atmega8 microcontroller}
%         \item {Tools: C, Atmel ATMEGA8}
%       \end{cvitems}
%     }
%     {}
